...
const Notification = ({
  ...
  return toast.custom(
    t => (
      <div
        className={`flex flex-row items-start justify-between max-w-full rounded-md shadow-2xl hover:shadow-none bg-base-200 p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${
